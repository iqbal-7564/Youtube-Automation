...
_HOOK: dict[str, list[str]] = {
    ...
    "TECHNOLOGY":  ["futuristic technology circuit board glow",    "robot artificial intelligence close",     "computer chip digital neon"],
    "PSYCHOLOGY":  ["human brain close dramatic glow",             "mind psychology thought concept",         "neuroscience brain scan"],
    "MYTHOLOGY":   ["ancient god statue dramatic temple",          "mythological creature dramatic wide",      "ancient legend ruins stone"],
    "MEDICINE":    ["medical surgery dramatic close hospital",      "doctor laboratory research close",        "human anatomy body dramatic"],
    "MATHEMATICS": ["mathematical equation blackboard close",       "abstract numbers geometry pattern",       "infinite spiral fractal dramatic"],
    "ECONOMICS":   ["stock market graph dramatic crash rise",       "money currency gold coins close",         "financial district city aerial"],
    "PHYSICS":     ["particle accelerator energy beam dramatic",    "quantum wave physics abstract glow",      "gravity space time warp dramatic"],
}
...
_TENSION: dict[str, list[list[str]]] = {
    ...
    "TECHNOLOGY":  [["robot humanoid artificial intelligence", "ai machine learning data glow",           "futuristic robot close dramatic"],
                  ["computer server data center dark",        "fiber optic cable light speed",           "binary code digital stream"],
                  ["smartphone chip circuit close",           "technology innovation lab close",          "electronic component micro detail"],
                  ["cyber security hacker dark screen",       "digital encryption code screen",          "network data transfer glow"],
                  ["quantum computer lab glow",               "supercomputer processing power",           "technology future concept wide"]],
    "PSYCHOLOGY":  [["human eye close detail dramatic",       "face emotion expression close",            "brain scan mri glow dramatic"],
                  ["crowd behavior social psychology",        "mirror reflection psychology concept",     "shadow silhouette mind dramatic"],
                  ["optical illusion perception dramatic",    "brain thought concept abstract glow",      "memory recall concept dramatic"],
                  ["sleep dream psychology night concept",    "subconscious mind abstract dramatic",      "emotion color psychology concept"],
                  ["decision making brain concept glow",      "cognitive bias psychology abstract",       "fear response nervous system"]],
    "MYTHOLOGY":   [["greek god statue marble dramatic",      "ancient temple olympus dramatic wide",     "mythology hero sword dramatic"],
                  ["norse mythology viking rune stone",       "odin thor mythology dramatic wide",        "world tree yggdrasil concept"],
                  ["dragon fire mythological creature",       "ancient beast mythology dramatic",         "legendary monster dark dramatic"],
                  ["oracle ancient priestess temple",         "prophecy scroll ancient dramatic",         "underworld mythology dark dramatic"],
                  ["mythological battle gods dramatic wide",  "ancient myth warrior hero dramatic",       "legendary artifact mythology close"]],
    "MEDICINE":    [["human body anatomy dramatic close",     "surgery operating room dramatic",          "medical microscope cell close"],
                  ["virus bacteria microscope dramatic",      "immune system cell attack dramatic",       "pathogen organism close dramatic"],
                  ["hospital equipment modern dramatic",      "medical scan mri ct dramatic",             "doctor surgery close dramatic"],
                  ["organ heart beating close dramatic",      "blood vessel anatomy dramatic close",      "nerve signal body dramatic"],
                  ["medicine pill drug close dramatic",       "vaccine syringe medical dramatic",         "dna gene medical research"]],
    "MATHEMATICS": [["fibonacci spiral nature pattern",       "fractal geometry infinite dramatic",       "mathematical pattern abstract"],
                  ["prime number sequence abstract glow",    "infinity concept abstract dramatic",       "number theory blackboard close"],
                  ["geometric shape abstract dramatic",      "topology donut coffee cup concept",        "mathematical proof board dramatic"],
                  ["data graph statistics dramatic wide",    "algorithm flow chart dramatic glow",       "binary code mathematics abstract"],
                  ["golden ratio nature spiral close",       "chaos theory fractal dramatic",            "mathematical universe concept wide"]],
    "ECONOMICS":   [["stock market trading floor dramatic",   "financial graph crash rise dramatic",      "money currency pile close"],
                  ["gold bar vault wealth dramatic",         "cryptocurrency bitcoin dramatic glow",     "bank vault money dramatic"],
                  ["poverty inequality dramatic contrast",   "wealth gap dramatic wide concept",         "homeless versus rich dramatic"],
                  ["global trade ship cargo aerial wide",    "supply chain world map dramatic",          "oil tanker ocean aerial wide"],
                  ["inflation price rise concept dramatic",  "market crash news dramatic close",         "economic crisis crowd dramatic"]],
    "PHYSICS":     [["particle accelerator beam dramatic",    "atom nucleus energy dramatic glow",        "quantum particle wave abstract"],
                  ["gravity black hole space dramatic",      "spacetime warp dramatic concept",          "relativity time dilation concept"],
                  ["nuclear fusion plasma energy glow",      "magnetic field visualization dramatic",    "electromagnetic wave spectrum"],
                  ["double slit experiment light dramatic",  "quantum entanglement concept glow",        "wave particle duality abstract"],
                  ["speed of light concept dramatic wide",   "energy matter conversion dramatic",        "thermodynamics heat energy concept"]],
}
...
_CORE: dict[str, list[list[str]]] = {
    ...
    "TECHNOLOGY":  [["circuit board close up dramatic glow",   "microchip processor technology close",    "electronic circuit neon dramatic"],
                  ["robot arm factory automation close",      "artificial intelligence robot face",       "machine learning data visual"],
                  ["satellite dish technology aerial wide",   "space telescope technology dramatic",      "launch rocket technology flame"],
                  ["virtual reality headset person close",    "augmented reality technology concept",     "hologram technology futuristic"],
                  ["self driving car technology road",        "electric vehicle technology charging",     "drone swarm technology aerial"],
                  ["dna technology laboratory close",         "3d printing technology process close",     "nanotechnology microscope close"]],
    "PSYCHOLOGY":  [["brain mri scan glow dramatic close",     "neuron synapse connection dramatic glow", "brain activity heat map dramatic"],
                  ["psychology test experiment person",       "behavioral science research lab",          "cognitive test brain dramatic"],
                  ["crowd mob psychology dramatic wide",      "social behavior people dramatic",          "conformity experiment concept"],
                  ["fear response person dramatic close",     "adrenaline stress body dramatic",          "fight flight response concept"],
                  ["memory palace concept dramatic",          "false memory psychology concept",          "amnesia brain concept dramatic"],
                  ["hypnosis psychology dramatic concept",    "subconscious behavior dramatic wide",      "placebo effect medicine dramatic"]],
    "MYTHOLOGY":   [["zeus lightning bolt olympus dramatic",   "ancient greek temple columns wide",       "mythology battle epic dramatic"],
                  ["norse rune inscription stone close",      "viking mythology ship dramatic ocean",     "thor hammer mythology dramatic"],
                  ["ancient egypt mythology hieroglyphic",    "anubis egypt god dramatic dark",           "egyptian mythology ritual dramatic"],
                  ["dragon mythology fire dramatic wide",     "phoenix rebirth fire mythology",           "serpent mythology dark dramatic"],
                  ["atlantis lost city mythology concept",    "underwater ruins mythology dramatic",      "sunken civilization mythology wide"],
                  ["mythology map ancient world dramatic",    "oracle delphi temple dramatic",            "prophecy mythology stone tablet"]],
    "MEDICINE":    [["blood cell microscope close dramatic",   "immune cell attacking virus dramatic",    "dna helix medical research close"],
                  ["brain surgery operating room dramatic",   "surgical tools close medical dramatic",   "surgeon hands operating dramatic"],
                  ["x-ray skeleton body dramatic",            "mri brain scan dramatic glow",            "ultrasound scan medical dramatic"],
                  ["antibiotic pill drug molecule close",     "vaccine development laboratory close",     "drug trial research dramatic"],
                  ["heart beating anatomy close dramatic",    "lung breathing anatomy dramatic",          "liver kidney organ anatomy close"],
                  ["pandemic virus spread dramatic map",      "hospital emergency dramatic wide",         "medical discovery breakthrough lab"]],
    "MATHEMATICS": [["equation blackboard chalk dramatic",     "mathematical proof whiteboard close",      "calculus formula complex dramatic"],
                  ["fractal zoom infinite dramatic abstract", "mandelbrot set fractal dramatic glow",    "chaos theory pattern dramatic"],
                  ["prime number spiral abstract dramatic",   "riemann hypothesis concept abstract",      "mathematical constant pi dramatic"],
                  ["topology shape transformation dramatic",  "knot theory mathematics abstract",         "four dimensions concept dramatic"],
                  ["probability statistics dice concept",     "bell curve normal distribution",           "game theory strategy concept"],
                  ["cryptography code mathematics close",     "algorithm sorting visualization",          "graph theory network nodes glow"]],
    "ECONOMICS":   [["wall street trading dramatic aerial",    "stock ticker numbers dramatic glow",      "financial crisis crash dramatic"],
                  ["gold standard coins bullion dramatic",    "bitcoin cryptocurrency digital glow",      "fiat currency printing dramatic"],
                  ["income inequality wealth gap visual",     "poverty slum versus skyscraper dramatic",  "social class divide dramatic wide"],
                  ["factory production line automation",      "global shipping container port aerial",    "supply chain logistics dramatic"],
                  ["central bank interest rate concept",      "inflation money value dramatic concept",   "recession economic graph dramatic"],
                  ["trade war tariff concept dramatic map",   "oil price crude barrel dramatic",          "gdp growth economy chart dramatic"]],
    "PHYSICS":     [["large hadron collider beam dramatic",    "particle collision energy dramatic glow", "subatomic particle track dramatic"],
                  ["black hole event horizon dramatic",       "gravitational wave detection dramatic",    "spacetime curvature dramatic wide"],
                  ["nuclear reactor plasma core dramatic",    "fusion energy sun interior dramatic",      "fission explosion energy dramatic"],
                  ["laser beam optics prism dramatic",        "light wave interference pattern",          "electromagnetic spectrum dramatic"],
                  ["superconductor levitation magnetic",      "quantum tunneling concept dramatic",       "zero point energy concept dramatic"],
                  ["time dilation clock relativity concept",  "speed light photon dramatic glow",         "entropy disorder universe dramatic"]],
}
...
_PAYOFF: dict[str, list[str]] = {
    ...
    "TECHNOLOGY":  ["technology future innovation beautiful",     "digital world concept wide glow",         "technology sunrise hope wide"],
    "PSYCHOLOGY":  ["person calm peaceful mind concept",          "brain harmony balance beautiful",          "human connection emotion warm"],
    "MYTHOLOGY":   ["mythology sunset epic landscape wide",       "ancient temple golden hour beautiful",     "legend hero triumph dramatic"],
    "MEDICINE":    ["medical breakthrough hope dramatic",         "patient recovery hospital warm",           "science saving lives dramatic"],
    "MATHEMATICS": ["mathematical beauty pattern nature wide",    "fractal universe beautiful wide",          "numbers cosmos connection beautiful"],
    "ECONOMICS":   ["economic prosperity city sunrise wide",      "wealth opportunity concept beautiful",     "financial future hope wide"],
    "PHYSICS":     ["universe physics beauty cosmos wide",        "energy light physics beautiful glow",      "physics discovery triumph dramatic"],
}
